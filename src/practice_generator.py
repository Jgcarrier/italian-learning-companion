...
# GCSE vocabulary with accurate English translations, organised by Cambridge syllabus topic.
# Tuples: (italian_raw, english, word_type, gender, category)
# gender: 'masculine' | 'feminine' | None
# word_type: 'noun' | 'verb' | 'adjective' | 'adverb' | 'phrase'
GCSE_VOCABULARY = [
    # --- Espressioni di tempo ---
    ("il turno", "turn / go", "noun", "masculine", "time"),
    ("la prossima settimana", "next week", "phrase", None, "time"),
    ("a volte", "sometimes", "adverb", None, "time"),
    ("alla fine", "in the end / finally", "phrase", None, "time"),
    ("all'improvviso", "suddenly", "adverb", None, "time"),
    ("ancora", "still / again", "adverb", None, "time"),
    ("finora", "so far / until now", "adverb", None, "time"),
    ("presto", "soon / early", "adverb", None, "time"),
    ("tardi", "late", "adverb", None, "time"),
    ("subito", "immediately / at once", "adverb", None, "time"),
    ("spesso", "often", "adverb", None, "time"),
    ("di solito", "usually", "adverb", None, "time"),
    ("qualche volta", "sometimes", "adverb", None, "time"),
    ("ogni giorno", "every day", "phrase", None, "time"),
    ("ogni settimana", "every week", "phrase", None, "time"),
    ("durante", "during", "adverb", None, "time"),
    ("mentre", "while / whilst", "adverb", None, "time"),
    ("poi", "then / afterwards", "adverb", None, "time"),
    ("dopo", "after / afterwards", "adverb", None, "time"),
    ("prima", "before / first", "adverb", None, "time"),
    ("adesso", "now", "adverb", None, "time"),
    ("ora", "now / hour", "adverb", None, "time"),
    ("oggi", "today", "adverb", None, "time"),
    ("ieri", "yesterday", "adverb", None, "time"),
    ("domani", "tomorrow", "adverb", None, "time"),
    ("la mattina", "morning", "noun", "feminine", "time"),
    ("il pomeriggio", "afternoon", "noun", "masculine", "time"),
    ("la sera", "evening", "noun", "feminine", "time"),
    ("la notte", "night", "noun", "feminine", "time"),
    ("il giorno", "day", "noun", "masculine", "time"),
    ("la settimana", "week", "noun", "feminine", "time"),
    ("il mese", "month", "noun", "masculine", "time"),
    ("l'anno", "year", "noun", "masculine", "time"),
    ("il fine settimana", "weekend", "noun", "masculine", "time"),
    # --- Giorni e mesi (no article in translation context) ---
    ("lunedì", "Monday", "noun", None, "days"),
    ("martedì", "Tuesday", "noun", None, "days"),
    ("mercoledì", "Wednesday", "noun", None, "days"),
    ("giovedì", "Thursday", "noun", None, "days"),
    ("venerdì", "Friday", "noun", None, "days"),
    ("sabato", "Saturday", "noun", None, "days"),
    ("domenica", "Sunday", "noun", None, "days"),
    ("gennaio", "January", "noun", None, "months"),
    ("febbraio", "February", "noun", None, "months"),
    ("marzo", "March", "noun", None, "months"),
    ("aprile", "April", "noun", None, "months"),
    ("maggio", "May", "noun", None, "months"),
    ("giugno", "June", "noun", None, "months"),
    ("luglio", "July", "noun", None, "months"),
    ("agosto", "August", "noun", None, "months"),
    ("settembre", "September", "noun", None, "months"),
    ("ottobre", "October", "noun", None, "months"),
    ("novembre", "November", "noun", None, "months"),
    ("dicembre", "December", "noun", None, "months"),
    # --- Stagioni ---
    ("la primavera", "spring", "noun", "feminine", "seasons"),
    ("l'estate", "summer", "noun", "feminine", "seasons"),
    ("l'autunno", "autumn", "noun", "masculine", "seasons"),
    ("l'inverno", "winter", "noun", "masculine", "seasons"),
    # --- Cibo e bevande ---
    ("l'acqua", "water", "noun", "feminine", "food"),
    ("il succo", "juice", "noun", "masculine", "food"),
    ("il latte", "milk", "noun", "masculine", "food"),
    ("il caffè", "coffee", "noun", "masculine", "food"),
    ("il tè", "tea", "noun", "masculine", "food"),
    ("il vino", "wine", "noun", "masculine", "food"),
    ("la birra", "beer", "noun", "feminine", "food"),
    ("il pane", "bread", "noun", "masculine", "food"),
    ("la pasta", "pasta", "noun", "feminine", "food"),
    ("il riso", "rice", "noun", "masculine", "food"),
    ("la pizza", "pizza", "noun", "feminine", "food"),
    ("la carne", "meat", "noun", "feminine", "food"),
    ("il pesce", "fish", "noun", "masculine", "food"),
    ("il pollo", "chicken", "noun", "masculine", "food"),
    ("il manzo", "beef", "noun", "masculine", "food"),
    ("il maiale", "pork", "noun", "masculine", "food"),
    ("l'agnello", "lamb", "noun", "masculine", "food"),
    ("il formaggio", "cheese", "noun", "masculine", "food"),
    ("il prosciutto", "ham", "noun", "masculine", "food"),
    ("l'uovo", "egg", "noun", "masculine", "food"),
    ("il burro", "butter", "noun", "masculine", "food"),
    ("lo zucchero", "sugar", "noun", "masculine", "food"),
    ("il sale", "salt", "noun", "masculine", "food"),
    ("l'olio", "oil", "noun", "masculine", "food"),
    ("l'aglio", "garlic", "noun", "masculine", "food"),
    ("la cipolla", "onion", "noun", "feminine", "food"),
    ("il pomodoro", "tomato", "noun", "masculine", "food"),
    ("la patata", "potato", "noun", "feminine", "food"),
    ("la carota", "carrot", "noun", "feminine", "food"),
    ("la lattuga", "lettuce", "noun", "feminine", "food"),
    ("l'insalata", "salad / lettuce", "noun", "feminine", "food"),
    ("la mela", "apple", "noun", "feminine", "food"),
    ("l'arancia", "orange", "noun", "feminine", "food"),
    ("il limone", "lemon", "noun", "masculine", "food"),
    ("la banana", "banana", "noun", "feminine", "food"),
    ("la fragola", "strawberry", "noun", "feminine", "food"),
    ("l'uva", "grapes", "noun", "feminine", "food"),
    ("l'ananas", "pineapple", "noun", "masculine", "food"),
    ("l'albicocca", "apricot", "noun", "feminine", "food"),
    ("il melone", "melon", "noun", "masculine", "food"),
    ("la pesca", "peach", "noun", "feminine", "food"),
    ("la frutta", "fruit", "noun", "feminine", "food"),
    ("la verdura", "vegetables", "noun", "feminine", "food"),
    ("il dolce", "dessert / sweet", "noun", "masculine", "food"),
    ("la torta", "cake / tart", "noun", "feminine", "food"),
    ("il gelato", "ice cream", "noun", "masculine", "food"),
    ("la prima colazione", "breakfast", "noun", "feminine", "food"),
    ("il pranzo", "lunch", "noun", "masculine", "food"),
    ("la cena", "dinner / supper", "noun", "feminine", "food"),
    ("lo spuntino", "snack", "noun", "masculine", "food"),
    ("l'antipasto", "starter / appetiser", "noun", "masculine", "food"),
    ("il primo piatto", "first course", "noun", "masculine", "food"),
    ("il secondo piatto", "second course / main course", "noun", "masculine", "food"),
    ("il contorno", "side dish", "noun", "masculine", "food"),
    ("il menu", "menu", "noun", "masculine", "food"),
    ("il piatto", "dish / plate", "noun", "masculine", "food"),
    ("la forchetta", "fork", "noun", "feminine", "food"),
    ("il coltello", "knife", "noun", "masculine", "food"),
    ("il cucchiaio", "spoon", "noun", "masculine", "food"),
    ("il bicchiere", "glass", "noun", "masculine", "food"),
    ("avere fame", "to be hungry", "phrase", None, "food"),
    ("avere sete", "to be thirsty", "phrase", None, "food"),
    ("mangiare", "to eat", "verb", None, "food"),
    ("bere", "to drink", "verb", None, "food"),
    ("cucinare", "to cook", "verb", None, "food"),
    ("assaggiare", "to taste / to try (food)", "verb", None, "food"),
    ("squisito", "delicious / exquisite", "adjective", None, "food"),
    ("buono", "good / tasty", "adjective", None, "food"),
    ("cattivo", "bad / unpleasant", "adjective", None, "food"),
    ("dolce", "sweet", "adjective", None, "food"),
    ("salato", "salty / savoury", "adjective", None, "food"),
    ("piccante", "spicy / hot", "adjective", None, "food"),
    # --- Famiglia ---
    ("il padre", "father", "noun", "masculine", "family"),
    ("la madre", "mother", "noun", "feminine", "family"),
    ("il fratello", "brother", "noun", "masculine", "family"),
    ("la sorella", "sister", "noun", "feminine", "family"),
    ("il nonno", "grandfather", "noun", "masculine", "family"),
    ("la nonna", "grandmother", "noun", "feminine", "family"),
    ("lo zio", "uncle", "noun", "masculine", "family"),
    ("la zia", "aunt", "noun", "feminine", "family"),
    ("il cugino", "cousin (male)", "noun", "masculine", "family"),
    ("la cugina", "cousin (female)", "noun", "feminine", "family"),
    ("il marito", "husband", "noun", "masculine", "family"),
    ("la moglie", "wife", "noun", "feminine", "family"),
    ("il figlio", "son", "noun", "masculine", "family"),
    ("la figlia", "daughter", "noun", "feminine", "family"),
    ("i figli", "children / sons", "noun", "masculine", "family"),
    ("il nipote", "nephew / grandson", "noun", "masculine", "family"),
    ("la nipote", "niece / granddaughter", "noun", "feminine", "family"),
    ("il genero", "son-in-law", "noun", "masculine", "family"),
    ("la nuora", "daughter-in-law", "noun", "feminine", "family"),
    ("il suocero", "father-in-law", "noun", "masculine", "family"),
    ("la suocera", "mother-in-law", "noun", "feminine", "family"),
    ("il fidanzato", "boyfriend / fiancé", "noun", "masculine", "family"),
    ("la fidanzata", "girlfriend / fiancée", "noun", "feminine", "family"),
    ("il partner", "partner", "noun", "masculine", "family"),
    ("sposarsi", "to get married", "verb", None, "family"),
    ("divorziare", "to divorce", "verb", None, "family"),
    ("andare d'accordo", "to get on well", "phrase", None, "family"),
    # --- Casa ---
    ("la casa", "house / home", "noun", "feminine", "home"),
    ("l'appartamento", "flat / apartment", "noun", "masculine", "home"),
    ("la stanza", "room", "noun", "feminine", "home"),
    ("il salotto", "living room", "noun", "masculine", "home"),
    ("la cucina", "kitchen", "noun", "feminine", "home"),
    ("la camera da letto", "bedroom", "noun", "feminine", "home"),
    ("il bagno", "bathroom", "noun", "masculine", "home"),
    ("il giardino", "garden", "noun", "masculine", "home"),
    ("il balcone", "balcony", "noun", "masculine", "home"),
    ("le scale", "stairs", "noun", "feminine", "home"),
    ("il piano", "floor / storey", "noun", "masculine", "home"),
    ("il primo piano", "first floor", "noun", "masculine", "home"),
    ("il piano terra", "ground floor", "noun", "masculine", "home"),
    ("il letto", "bed", "noun", "masculine", "home"),
    ("il divano", "sofa", "noun", "masculine", "home"),
    ("la sedia", "chair", "noun", "feminine", "home"),
    ("il tavolo", "table", "noun", "masculine", "home"),
    ("l'armadio", "wardrobe / cupboard", "noun", "masculine", "home"),
    ("lo scaffale", "shelf / bookcase", "noun", "masculine", "home"),
    ("la scrivania", "desk", "noun", "feminine", "home"),
    ("la lampada", "lamp", "noun", "feminine", "home"),
    ("la finestra", "window", "noun", "feminine", "home"),
    ("la porta", "door", "noun", "feminine", "home"),
    ("il frigorifero", "fridge", "noun", "masculine", "home"),
    ("il forno", "oven", "noun", "masculine", "home"),
    ("la lavatrice", "washing machine", "noun", "feminine", "home"),
    ("il televisore", "television set", "noun", "masculine", "home"),
    ("pulire", "to clean", "verb", None, "home"),
    ("riordinare", "to tidy up", "verb", None, "home"),
    ("passare l'aspirapolvere", "to vacuum / hoover", "phrase", None, "home"),
    ("fare il bucato", "to do the laundry", "phrase", None, "home"),
    ("lavare i piatti", "to wash the dishes", "phrase", None, "home"),
    ("fare il letto", "to make the bed", "phrase", None, "home"),
    # --- Città e luoghi ---
    ("la città", "city / town", "noun", "feminine", "city"),
    ("il paese", "village / town / country", "noun", "masculine", "city"),
    ("la strada", "street / road", "noun", "feminine", "city"),
    ("la piazza", "square / plaza", "noun", "feminine", "city"),
    ("il centro", "town centre", "noun", "masculine", "city"),
    ("il quartiere", "neighbourhood / district", "noun", "masculine", "city"),
    ("la stazione", "station", "noun", "feminine", "city"),
    ("l'aeroporto", "airport", "noun", "masculine", "city"),
    ("il porto", "port / harbour", "noun", "masculine", "city"),
    ("l'albergo", "hotel", "noun", "masculine", "city"),
    ("il ristorante", "restaurant", "noun", "masculine", "city"),
    ("il bar", "bar / café", "noun", "masculine", "city"),
    ("il negozio", "shop", "noun", "masculine", "city"),
    ("il supermercato", "supermarket", "noun", "masculine", "city"),
    ("il mercato", "market", "noun", "masculine", "city"),
    ("la banca", "bank", "noun", "feminine", "city"),
    ("la farmacia", "pharmacy / chemist", "noun", "feminine", "city"),
    ("l'ospedale", "hospital", "noun", "masculine", "city"),
    ("la scuola", "school", "noun", "feminine", "city"),
    ("l'università", "university", "noun", "feminine", "city"),
    ("la chiesa", "church", "noun", "feminine", "city"),
    ("il museo", "museum", "noun", "masculine", "city"),
    ("il cinema", "cinema", "noun", "masculine", "city"),
    ("il teatro", "theatre", "noun", "masculine", "city"),
    ("il parco", "park", "noun", "masculine", "city"),
    ("la piscina", "swimming pool", "noun", "feminine", "city"),
    ("la palestra", "gym", "noun", "feminine", "city"),
    ("l'ufficio postale", "post office", "noun", "masculine", "city"),
    ("il municipio", "town hall", "noun", "masculine", "city"),
    ("la biblioteca", "library", "noun", "feminine", "city"),
    ("girare a destra", "to turn right", "phrase", None, "city"),
    ("girare a sinistra", "to turn left", "phrase", None, "city"),
    ("andare dritto", "to go straight on", "phrase", None, "city"),
    ("attraversare", "to cross", "verb", None, "city"),
    ("si trova", "it is located / it is found", "phrase", None, "city"),
    # --- Viaggi e trasporti ---
    ("il treno", "train", "noun", "masculine", "transport"),
    ("l'aereo", "aeroplane", "noun", "masculine", "transport"),
    ("l'autobus", "bus", "noun", "masculine", "transport"),
    ("la macchina", "car", "noun", "feminine", "transport"),
    ("la bicicletta", "bicycle", "noun", "feminine", "transport"),
    ("la moto", "motorbike", "noun", "feminine", "transport"),
    ("il taxi", "taxi", "noun", "masculine", "transport"),
    ("la nave", "ship / boat", "noun", "feminine", "transport"),
    ("il traghetto", "ferry", "noun", "masculine", "transport"),
    ("l'ambulanza", "ambulance", "noun", "feminine", "transport"),
    ("il biglietto", "ticket", "noun", "masculine", "transport"),
    ("l'orario", "timetable / schedule", "noun", "masculine", "transport"),
    ("il ritardo", "delay", "noun", "masculine", "transport"),
    ("arrivare", "to arrive", "verb", None, "transport"),
    ("partire", "to leave / depart", "verb", None, "transport"),
    ("viaggiare", "to travel", "verb", None, "transport"),
    ("prenotare", "to book / reserve", "verb", None, "transport"),
    ("perdere il treno", "to miss the train", "phrase", None, "transport"),
    ("in anticipo", "early / in advance", "phrase", None, "transport"),
    ("in ritardo", "late / delayed", "phrase", None, "transport"),
    ("il passaporto", "passport", "noun", "masculine", "transport"),
    ("la valigia", "suitcase", "noun", "feminine", "transport"),
    ("il bagaglio", "luggage", "noun", "masculine", "transport"),
    # --- Tempo libero e sport ---
    ("il calcio", "football", "noun", "masculine", "leisure"),
    ("il nuoto", "swimming", "noun", "masculine", "leisure"),
    ("la corsa", "running", "noun", "feminine", "leisure"),
    ("il tennis", "tennis", "noun", "masculine", "leisure"),
    ("lo sci", "skiing", "noun", "masculine", "leisure"),
    ("il ciclismo", "cycling", "noun", "masculine", "leisure"),
    ("la pallavolo", "volleyball", "noun", "feminine", "leisure"),
    ("il basket", "basketball", "noun", "masculine", "leisure"),
    ("la musica", "music", "noun", "feminine", "leisure"),
    ("la chitarra", "guitar", "noun", "feminine", "leisure"),
    ("il pianoforte", "piano", "noun", "masculine", "leisure"),
    ("il violino", "violin", "noun", "masculine", "leisure"),
    ("la batteria", "drums", "noun", "feminine", "leisure"),
    ("il flauto", "flute", "noun", "masculine", "leisure"),
    ("leggere", "to read", "verb", None, "leisure"),
    ("guardare la TV", "to watch TV", "phrase", None, "leisure"),
    ("ascoltare la musica", "to listen to music", "phrase", None, "leisure"),
    ("giocare", "to play (a game/sport)", "verb", None, "leisure"),
    ("suonare", "to play (an instrument)", "verb", None, "leisure"),
    ("disegnare", "to draw", "verb", None, "leisure"),
    ("dipingere", "to paint", "verb", None, "leisure"),
    ("fare una passeggiata", "to go for a walk", "phrase", None, "leisure"),
    ("andare in palestra", "to go to the gym", "phrase", None, "leisure"),
    ("allenarsi", "to train / work out", "verb", None, "leisure"),
    ("vincere", "to win", "verb", None, "leisure"),
    ("perdere", "to lose", "verb", None, "leisure"),
    # --- Scuola e istruzione ---
    ("la classe", "class / classroom", "noun", "feminine", "school"),
    ("la lezione", "lesson", "noun", "feminine", "school"),
    ("il compito", "homework / task", "noun", "masculine", "school"),
    ...
    ("lo studente", "student (male)", "noun", "masculine", "school"),
    ("la studentessa", "student (female)", "noun", "feminine", "school"),
    ("studiare", "to study", "verb", None, "school"),
    ("imparare", "to learn", "verb", None, "school"),
    ("capire", "to understand", "verb", None, "school"),
    ("ripetere", "to repeat / revise", "verb", None, "school"),
    ("superare un esame", "to pass an exam", "phrase", None, "school"),
    ("bocciare", "to fail (an exam)", "verb", None, "school"),
    # --- Lavoro e carriera ---
    ("il lavoro", "work / job", "noun", "masculine", "work"),
    ("il posto di lavoro", "workplace", "noun", "masculine", "work"),
    ("l'ufficio", "office", "noun", "masculine", "work"),
    ("il medico", "doctor", "noun", "masculine", "work"),
    ("l'infermiere", "nurse (male)", "noun", "masculine", "work"),
    ("l'infermiera", "nurse (female)", "noun", "feminine", "work"),
    ("l'avvocato", "lawyer", "noun", "masculine", "work"),
    ("l'ingegnere", "engineer", "noun", "masculine", "work"),
    ("l'architetto", "architect", "noun", "masculine", "work"),
    ("il cuoco", "cook / chef", "noun", "masculine", "work"),
    ("il cameriere", "waiter", "noun", "masculine", "work"),
    ("la cameriera", "waitress", "noun", "feminine", "work"),
    ("il commesso", "shop assistant (male)", "noun", "masculine", "work"),
    ("la commessa", "shop assistant (female)", "noun", "feminine", "work"),
    ("il poliziotto", "police officer", "noun", "masculine", "work"),
    ("il pompiere", "firefighter", "noun", "masculine", "work"),
    ("il giornalista", "journalist", "noun", "masculine", "work"),
    ("il programmatore", "programmer", "noun", "masculine", "work"),
    ("lavorare", "to work", "verb", None, "work"),
    ("guadagnare", "to earn", "verb", None, "work"),
    ("cercare lavoro", "to look for work", "phrase", None, "work"),
    ("lo stipendio", "salary / wage", "noun", "masculine", "work"),
    ("il colloquio", "interview", "noun", "masculine", "work"),
    ("il contratto", "contract", "noun", "masculine", "work"),
    # --- Salute e malattie ---
    ("la salute", "health", "noun", "feminine", "health"),
    ("la malattia", "illness / disease", "noun", "feminine", "health"),
    ("il dolore", "pain / ache", "noun", "masculine", "health"),
    ("la febbre", "fever / temperature", "noun", "feminine", "health"),
    ("il raffreddore", "cold (illness)", "noun", "masculine", "health"),
    ("l'influenza", "flu", "noun", "feminine", "health"),
    ("la tosse", "cough", "noun", "feminine", "health"),
    ("il mal di testa", "headache", "noun", "masculine", "health"),
    ("il mal di stomaco", "stomachache", "noun", "masculine", "health"),
    ("il mal di denti", "toothache", "noun", "masculine", "health"),
    ("il mal di gola", "sore throat", "noun", "masculine", "health"),
    ("la schiena", "back", "noun", "feminine", "health"),
    ("la gamba", "leg", "noun", "feminine", "health"),
    ("il braccio", "arm", "noun", "masculine", "health"),
    ("la mano", "hand", "noun", "feminine", "health"),
    ("il piede", "foot", "noun", "masculine", "health"),
    ("la testa", "head", "noun", "feminine", "health"),
    ("gli occhi", "eyes", "noun", "masculine", "health"),
    ("l'orecchio", "ear", "noun", "masculine", "health"),
    ("il naso", "nose", "noun", "masculine", "health"),
    ("la bocca", "mouth", "noun", "feminine", "health"),
    ("la schiena", "back", "noun", "feminine", "health"),
    ("ammalarsi", "to fall ill / get sick", "verb", None, "health"),
    ("avere la febbre", "to have a temperature", "phrase", None, "health"),
    ("avere l'influenza", "to have the flu", "phrase", None, "health"),
    ("avere mal di testa", "to have a headache", "phrase", None, "health"),
    ("andare dal medico", "to go to the doctor", "phrase", None, "health"),
    ("prendere le medicine", "to take medicine", "phrase", None, "health"),
    ("guarire", "to recover / get better", "verb", None, "health"),
    ("la medicina", "medicine / medication", "noun", "feminine", "health"),
    ("la pillola", "pill / tablet", "noun", "feminine", "health"),
    ("l'ospedale", "hospital", "noun", "masculine", "health"),
    ("il pronto soccorso", "A&E / emergency room", "noun", "masculine", "health"),
    # --- Descrizione fisica e carattere ---
    ("alto", "tall", "adjective", None, "description"),
    ("basso", "short", "adjective", None, "description"),
    ("magro", "thin / slim", "adjective", None, "description"),
    ("grasso", "fat", "adjective", None, "description"),
    ("robusto", "stocky / sturdy", "adjective", None, "description"),
    ("giovane", "young", "adjective", None, "description"),
    ("vecchio", "old", "adjective", None, "description"),
    ("bello", "beautiful / handsome", "adjective", None, "description"),
    ("brutto", "ugly", "adjective", None, "description"),
    ("i capelli corti", "short hair", "phrase", None, "description"),
    ("i capelli lunghi", "long hair", "phrase", None, "description"),
    ("i capelli biondi", "blond hair", "phrase", None, "description"),
    ("i capelli neri", "black hair", "phrase", None, "description"),
    ("i capelli castani", "brown hair", "phrase", None, "description"),
    ("i capelli rossi", "red hair", "phrase", None, "description"),
    ("gli occhi azzurri", "blue eyes", "phrase", None, "description"),
    ("gli occhi verdi", "green eyes", "phrase", None, "description"),
    ("gli occhi marroni", "brown eyes", "phrase", None, "description"),
    ("simpatico", "nice / likeable", "adjective", None, "description"),
    ("antipatico", "unpleasant / unlikeable", "adjective", None, "description"),
    ("gentile", "kind", "adjective", None, "description"),
    ("timido", "shy / timid", "adjective", None, "description"),
    ("coraggioso", "brave / courageous", "adjective", None, "description"),
    ("generoso", "generous", "adjective", None, "description"),
    ("egoista", "selfish", "adjective", None, "description"),
    ("onesto", "honest", "adjective", None, "description"),
    ("pigro", "lazy", "adjective", None, "description"),
    ("diligente", "hardworking / diligent", "adjective", None, "description"),
    ("intelligente", "intelligent / clever", "adjective", None, "description"),
    ("creativo", "creative", "adjective", None, "description"),
    # --- Vestiti ---
    ("i vestiti", "clothes", "noun", "masculine", "clothes"),
    ("la camicia", "shirt", "noun", "feminine", "clothes"),
    ("la maglietta", "T-shirt", "noun", "feminine", "clothes"),
    ("il maglione", "jumper / sweater", "noun", "masculine", "clothes"),
    ("i pantaloni", "trousers", "noun", "masculine", "clothes"),
    ("i jeans", "jeans", "noun", "masculine", "clothes"),
    ("la gonna", "skirt", "noun", "feminine", "clothes"),
    ("il vestito", "dress / suit", "noun", "masculine", "clothes"),
    ("la giacca", "jacket", "noun", "feminine", "clothes"),
    ("il cappotto", "coat", "noun", "masculine", "clothes"),
    ("le scarpe", "shoes", "noun", "feminine", "clothes"),
    ("gli stivali", "boots", "noun", "masculine", "clothes"),
    ("i calzini", "socks", "noun", "masculine", "clothes"),
    ("il cappello", "hat", "noun", "masculine", "clothes"),
    ("la sciarpa", "scarf", "noun", "feminine", "clothes"),
    ("i guanti", "gloves", "noun", "masculine", "clothes"),
    ("indossare", "to wear", "verb", None, "clothes"),
    ("mettere", "to put on", "verb", None, "clothes"),
    # --- Ambiente e natura ---
    ("l'ambiente", "environment", "noun", "masculine", "environment"),
    ("la natura", "nature", "noun", "feminine", "environment"),
    ("il clima", "climate", "noun", "masculine", "environment"),
    ("il tempo", "weather", "noun", "masculine", "environment"),
    ("l'inquinamento", "pollution", "noun", "masculine", "environment"),
    ("il riciclaggio", "recycling", "noun", "masculine", "environment"),
    ("l'energia rinnovabile", "renewable energy", "noun", "feminine", "environment"),
    ("il cambiamento climatico", "climate change", "noun", "masculine", "environment"),
    ("riciclare", "to recycle", "verb", None, "environment"),
    ("risparmiare energia", "to save energy", "phrase", None, "environment"),
    ("il bosco", "wood / forest", "noun", "masculine", "environment"),
    ("il mare", "sea", "noun", "masculine", "environment"),
    ("la montagna", "mountain", "noun", "feminine", "environment"),
    ("il lago", "lake", "noun", "masculine", "environment"),
    ("il fiume", "river", "noun", "masculine", "environment"),
    ("la spiaggia", "beach", "noun", "feminine", "environment"),
    ("il sole", "sun", "noun", "masculine", "environment"),
    ("la pioggia", "rain", "noun", "feminine", "environment"),
    ("la neve", "snow", "noun", "feminine", "environment"),
    ("il vento", "wind", "noun", "masculine", "environment"),
    ("fa caldo", "it is hot", "phrase", None, "environment"),
    ("fa freddo", "it is cold", "phrase", None, "environment"),
    ("è nuvoloso", "it is cloudy", "phrase", None, "environment"),
    ("piove", "it is raining", "phrase", None, "environment"),
    ("nevica", "it is snowing", "phrase", None, "environment"),
    # --- Tecnologia e comunicazione ---
    ("il computer", "computer", "noun", "masculine", "technology"),
    ("il telefono", "telephone", "noun", "masculine", "technology"),
    ("il cellulare", "mobile phone", "noun", "masculine", "technology"),
    ("internet", "internet", "noun", None, "technology"),
    ("il sito web", "website", "noun", "masculine", "technology"),
    ("il messaggio", "message", "noun", "masculine", "technology"),
    ("l'email", "email", "noun", "feminine", "technology"),
    ("i social media", "social media", "noun", "masculine", "technology"),
    ("scaricare", "to download", "verb", None, "technology"),
    ("inviare", "to send", "verb", None, "technology"),
    ("cercare", "to search / look for", "verb", None, "technology"),
    ("collegarsi", "to connect / log on", "verb", None, "technology"),
    # --- Cultura e feste ---
    ("il Natale", "Christmas", "noun", "masculine", "culture"),
    ("la Pasqua", "Easter", "noun", "feminine", "culture"),
    ("il Capodanno", "New Year's Day", "noun", "masculine", "culture"),
    ("il compleanno", "birthday", "noun", "masculine", "culture"),
    ("festeggiare", "to celebrate", "verb", None, "culture"),
    ("fare gli auguri", "to wish (someone well) / to celebrate", "phrase", None, "culture"),
    ("il regalo", "gift / present", "noun", "masculine", "culture"),
    ("la tradizione", "tradition", "noun", "feminine", "culture"),
    ("la festa", "party / celebration / public holiday", "noun", "feminine", "culture"),
    # --- Espressioni utili / Saluti ---
    ("grazie", "thank you", "phrase", None, "expressions"),
    ("prego", "you're welcome", "phrase", None, "expressions"),
    ("scusi", "excuse me (formal)", "phrase", None, "expressions"),
    ("per favore", "please", "phrase", None, "expressions"),
    ("mi dispiace", "I'm sorry", "phrase", None, "expressions"),
    ("va bene", "OK / all right", "phrase", None, "expressions"),
    ("certo", "certainly / of course", "phrase", None, "expressions"),
    ("forse", "perhaps / maybe", "adverb", None, "expressions"),
    ("però", "but / however", "adverb", None, "expressions"),
    ("quindi", "so / therefore", "adverb", None, "expressions"),
    ("anche", "also / too", "adverb", None, "expressions"),
    ("invece", "instead / on the other hand", "adverb", None, "expressions"),
    ("purtroppo", "unfortunately", "adverb", None, "expressions"),
    ("fortunatamente", "fortunately", "adverb", None, "expressions"),
    ("secondo me", "in my opinion", "phrase", None, "expressions"),
    ("a mio parere", "in my opinion", "phrase", None, "expressions"),
    ("mi piace", "I like", "phrase", None, "expressions"),
    ("non mi piace", "I don't like", "phrase", None, "expressions"),
    ("mi piacerebbe", "I would like", "phrase", None, "expressions"),
    ("preferisco", "I prefer", "phrase", None, "expressions"),
    ("penso che", "I think that", "phrase", None, "expressions"),
    ("credo che", "I believe that", "phrase", None, "expressions"),
    ("spero che", "I hope that", "phrase", None, "expressions"),
    ("sono d'accordo", "I agree", "phrase", None, "expressions"),
    ("non sono d'accordo", "I disagree", "phrase", None, "expressions"),
    # --- Colori ---
    ("rosso", "red", "adjective", None, "colours"),
    ("blu", "blue", "adjective", None, "colours"),
    ("verde", "green", "adjective", None, "colours"),
    ("giallo", "yellow", "adjective", None, "colours"),
    ("arancione", "orange", "adjective", None, "colours"),
    ("viola", "purple", "adjective", None, "colours"),
    ("rosa", "pink", "adjective", None, "colours"),
    ("bianco", "white", "adjective", None, "colours"),
    ("nero", "black", "adjective", None, "colours"),
    ("grigio", "grey", "adjective", None, "colours"),
    ("marrone", "brown", "adjective", None, "colours"),
    ("azzurro", "light blue / sky blue", "adjective", None, "colours"),
    # --- Nazioni e nazionalità ---
    ("l'Italia", "Italy", "noun", "feminine", "countries"),
    ("il Regno Unito", "the United Kingdom", "noun", "masculine", "countries"),
    ("la Francia", "France", "noun", "feminine", "countries"),
    ("la Spagna", "Spain", "noun", "feminine", "countries"),
    ("la Germania", "Germany", "noun", "feminine", "countries"),
    ("gli Stati Uniti", "the United States", "noun", "masculine", "countries"),
    ("italiano", "Italian", "adjective", None, "countries"),
    ("inglese", "English / British", "adjective", None, "countries"),
    ("francese", "French", "adjective", None, "countries"),
    ("spagnolo", "Spanish", "adjective", None, "countries"),
    ("tedesco", "German", "adjective", None, "countries"),
    ("americano", "American", "adjective", None, "countries"),
]
...
class PracticeGenerator:
    ...
    def generate_vocabulary_quiz(self, level: str = "A1", count: int = 10,
        ...
        # GCSE uses the hardcoded list with accurate translations (DB data had no English translations)
        if level == "GCSE":
            pool = list(GCSE_VOCABULARY)
            random.shuffle(pool)
            selected = pool[:count]
            for italian_raw, english, word_type, gender, category in selected:
                words.append((italian_raw, english, word_type, gender, category))
        else:
            cursor = self.db.conn.cursor()
            cursor.execute("""
        ...
        # Article prefixes used to detect when an Italian string already contains its article
        _ART_PREFIXES = ("il ", "la ", "lo ", "l'", "i ", "gli ", "le ")

        questions = []

        for word in words:
            italian, english, word_type, gender, category = word
            # is_noun drives article logic; skip if Italian already includes the article (GCSE list)
            ...
            if direction == "it_to_en":
                ...
                if is_noun:
                    ...
                    question_text = f"Translate: {en_prompt}"
                    answer = italian
                else:
